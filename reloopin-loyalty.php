...
define('RELOOPIN_LOYALTY_VERSION', '1.3.3');
...
function reloopin_loyalty_init()
{
    ...
    require_once RELOOPIN_LOYALTY_PLUGIN_DIR . 'includes/class-loyalty-points-estimate.php';
    ...
    new ReLoopin_Loyalty_Points_Estimate($api);
}
